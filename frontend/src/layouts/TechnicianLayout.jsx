...
function TechnicianLayout() {
  ...
  // Format today's date for display dynamically
        ...
        <header className="technician-topbar cf-admin-topbar">
          <div className="cf-topbar-leading">
            ...
            <div className="cf-topbar-context d-none d-lg-flex">
              ...
              {/* FIX: Call getFormattedHeaderDate() directly here */}
              <span className="cf-topbar-context-date">{getFormattedHeaderDate()}</span>
            </div>
          </div>
